...
#import "CKJFileManager.h"

@implementation CKJFileManager
...
+ (BOOL)createFileBelowPath:(NSString *)path fileName:(NSString *)fileName {
    ...
    BOOL result = [[NSFileManager defaultManager] createFileAtPath:itemFullPath contents:nil attributes:nil];
    return result;
}
...
+ (BOOL)createFolderBelowPath:(NSString *)path folderName:(NSString *)folderName {
    ...
    BOOL result = [[NSFileManager defaultManager] createDirectoryAtPath:folderFullPath withIntermediateDirectories:YES attributes:nil error:nil];
...
+ (BOOL)fileExistWithFileFullPath:(NSString *)fileFullPath {
    ...
    //判断这个路径是否是 存在的
    BOOL exist = [[NSFileManager defaultManager] fileExistsAtPath:fileFullPath isDirectory:&dir];
...
+ (BOOL)removeItemWithItemFullPath:(NSString *)itemFullPath {
    ...
    return [[NSFileManager defaultManager] removeItemAtPath:itemFullPath error:nil];
}
...
+ (BOOL)folderExistWithFolderFullPath:(NSString *)folderFullPath {
    ...
    //判断这个路径是否是 存在的
    BOOL exist = [[NSFileManager defaultManager] fileExistsAtPath:folderFullPath isDirectory:&dir];
...
+ (BOOL)moveItemAtPath:(NSString *)sourceFullPath toPath:(NSString *)destinationFullPath {
    ...
    return [[NSFileManager defaultManager] moveItemAtPath:sourceFullPath toPath:destinationFullPath error:nil];
}
...
+ (BOOL)copyItemAtPath:(NSString *)sourceFullPath toPath:(NSString *)destinationFullPath {
    ...
    return [[NSFileManager defaultManager] copyItemAtPath:sourceFullPath toPath:destinationFullPath error:nil];
}


+ (BOOL)renameItemAtPath:(NSString *)itemFullPath rename:(NSString *)newName {
    
    // NS[NSFileManager defaultManager] 没有提供直接重命名的方法， 只能通过其他方式 实现
...
+ (NSArray <NSString *>*)contentsOfDirectoryAtPath:(NSString *)folerFullPath {
    ...
    return [[NSFileManager defaultManager] contentsOfDirectoryAtPath:folerFullPath error:nil];
}
...
+ (NSDictionary <NSString *, id>*)attributesOfItemAtPath:(NSString *)itemFullPath {
    ...
    */
    ...
    return [[NSFileManager defaultManager] attributesOfItemAtPath:itemFullPath error:nil];
 }
...
+ (long long)folderSizeAtPath:(NSString *)folderPath {
    ...
    // 这个得到的是 文件的 相对路径
    NSArray *relativePathArr = [[NSFileManager defaultManager] subpathsAtPath:folderPath];
...
+ (BOOL)createFileAtPath:(NSString *)fileFullPath withData:(NSData *)data {
    ...
    return [[NSFileManager defaultManager] createFileAtPath:fileFullPath contents:data attributes:nil];
}
...
+ (NSData *)readDataAtPath:(NSString *)fileFullPath {
    ...
    return [[NSFileManager defaultManager] contentsAtPath:fileFullPath];
}
...
+ (BOOL)existPathAtPath:(NSString *)fullPath {
    ...
    //判断原路径是否是 存在的
    BOOL pathExist = [[NSFileManager defaultManager] fileExistsAtPath:fullPath isDirectory:&dir];
    return pathExist;
}
