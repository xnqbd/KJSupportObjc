...
+ (instancetype)commonWithCellHeight:(nullable NSNumber *)cellHeight detail:(nullable CKJCommonCellModelRowBlock)detail {
    return [self commonWithCellHeight:cellHeight cellModel_id:nil detailSettingBlock:detail didSelectRowBlock:nil];
}
