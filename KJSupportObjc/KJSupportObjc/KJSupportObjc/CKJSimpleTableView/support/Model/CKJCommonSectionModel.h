...
@class CKJCommonHeaderFooterModel, CKJCommonCellModel, CKJSimpleTableView, CKJCommonSectionModel, CKJCommonCellBGImageViewConfig;
...
/// 背景设置 依次看cell.cellBGConfig(默认为nil)，section.cellBGConfig(默认为nil)，style.cellBGConfig(默认有值)
@property (strong, nonatomic, nullable) CKJCommonCellBGImageViewConfig *cellBGConfig;
...
+ (instancetype)sectionWithCellModels:(NSArray <__kindof CKJCommonCellModel *>*)modelArray;
