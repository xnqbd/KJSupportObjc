...
NSString *_Nonnull const kOInput_DefaultPwd = @"kOInput_DefaultPwd";
NSString *_Nonnull const kOInput_DefaultConfirmPwd = @"kOInput_DefaultConfirmPwd";
NSString *_Nonnull const kOInput_FreshPwd = @"kOInput_FreshPwd";
NSString *_Nonnull const kOInput_FreshConfirmPwd = @"kOInput_FreshConfirmPwd";
...
- (instancetype)initWithSimpleTableView:(CKJSimpleTableView *)simpleTableView {
    ...
    // 密码
    NSString *_defaultPwd = [simpleTableView inputCellModelOfID:kOInput_DefaultPwd].getTfText;
    
    // 确认密码
    NSString *_defaultConfirmPwd = [simpleTableView inputCellModelOfID:kOInput_DefaultConfirmPwd].getTfText;
    
    // 新密码
    NSString *_freshPwd = [simpleTableView inputCellModelOfID:kOInput_FreshPwd].getTfText;
    
    // 新确认密码
    NSString *_freshConfirmPwd = [simpleTableView inputCellModelOfID:kOInput_FreshConfirmPwd].getTfText;
    ...
    self.email = _email;
    self.defaultPwd = _defaultPwd;
    self.defaultConfirmPwd = _defaultConfirmPwd;
    self.freshPwd = _freshPwd;
    self.freshConfirmPwd = _freshConfirmPwd;
