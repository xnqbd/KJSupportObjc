...
UIKIT_EXTERN NSString *_Nonnull const kOInput_DefaultPwd;
UIKIT_EXTERN NSString *_Nonnull const kOInput_DefaultConfirmPwd;
UIKIT_EXTERN NSString *_Nonnull const kOInput_FreshPwd;
UIKIT_EXTERN NSString *_Nonnull const kOInput_FreshConfirmPwd;
...
@property (copy, nonatomic, nullable) NSString *defaultPwd;
@property (copy, nonatomic, nullable) NSString *defaultConfirmPwd;
@property (copy, nonatomic, nullable) NSString *freshPwd;
@property (copy, nonatomic, nullable) NSString *freshConfirmPwd;
