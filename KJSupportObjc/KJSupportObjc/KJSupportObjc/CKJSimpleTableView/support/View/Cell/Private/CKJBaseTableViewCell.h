...
@property (weak, nonatomic) UILabel *readOnly_TitleLabel;


+ (instancetype _Nonnull)baseTableViewCellWithCellHeight:(nullable NSNumber *)cellHeight cellModel_id:(nullable NSString *)cellModel_id detail:(nullable CKJBaseTableViewCellRowBlock)detailSettingBlock didSelectRowBlock:(nullable CKJBaseTableViewCellRowBlock)didSelectRowBlock;
