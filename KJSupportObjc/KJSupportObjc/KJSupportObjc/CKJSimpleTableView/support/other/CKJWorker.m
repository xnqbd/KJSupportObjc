...
NSString *_Nonnull const KJPrefix_cDetailSetBlock = @"KJPrefix_cDetailSetBlock";
NSString *_Nonnull const KJPrefix_cCustomBlock = @"KJPrefix_cCustomBlock";
...
- (void)reloadBtnUI {
    [CKJWorker reloadBtn:self.readOnly_Btn btnData:self];
}
