 ...
 */
+ (instancetype )kjwd_arrayWithResponseDataModels:(NSArray * _Nullable)ResponseDataModels CellModelClass:(Class )CellModelClass callBack:(void(^_Nullable )(__kindof __weak CKJCommonCellModel * currentModel))callBack;
