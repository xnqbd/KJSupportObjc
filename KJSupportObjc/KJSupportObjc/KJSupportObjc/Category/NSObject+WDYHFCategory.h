...
/**
 Json字符串转成字典
 */
+ (NSDictionary <NSString *, id>*)kjwd_readFromJsonString:(nullable NSString *)jsonStr;
...
/// APP可见VC
+ (__kindof UIViewController *)kjwd_appVisibleVC;

/** 得到当前控制器 被 哪一个控制器 推过来的 控制器 */
- (nullable __kindof UIViewController *)kjwd_previous_PushedVC;
...
/// 每次调用得到的 都是不一样的， 如果想要设备的uuid，请使用 CKJKeyChain
