...
//    [self.simpleTableView kjwd_reloadSection:1 withRowAnimation:UITableViewRowAnimationRight];
    ...
    CKJCommonSectionModel *section1 = [CKJCommonSectionModel sectionWithHeaderAttString:WDCKJAttributed2(@"CKJCell的结构", [UIColor grayColor], @15) detailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
        ...
        CKJCellModel *model1 = [CKJCellModel modelWithCellHeight:84 cellModel_id:@(kkkk_YHFStatusCellID) detailSettingBlock:^(CKJCellModel *m) {
            ...
            m.btn5Model = [CKJBtn5Model btn5ModelWithSize:CGSizeMake(60, 30) normalImage:[UIImage imageNamed:@"new_personal_头像"] rightMargin:0 detailSettingBlock:^(CKJBtn5Model * _Nonnull sender) {
    ...
    CKJCommonSectionModel *section2 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
        ...
        CKJCellModel *model0 = [CKJCellModel modelWithCellHeight:44 cellModel_id:nil detailSettingBlock:^(CKJCellModel *m) {
            ...
            m.btn7Model = [CKJBtn7Model btn7ModelWithSize:CGSizeMake(30, 30) normalImage:[UIImage kjwd_imageNamed:@"touxiang.jpg"] rightMargin:10 detailSettingBlock:^(CKJBtn7Model *sender) {
        ...
        CKJCellModel *model3 = [CKJCellModel modelWithCellHeight:44 cellModel_id:nil detailSettingBlock:^(__kindof CKJCellModel * _Nonnull m) {
            ...
            m.btn7Model = [CKJBtn7Model btn7ModelWithSize:CGSizeMake(100, 30) normalImage:nil rightMargin:25 detailSettingBlock:^(CKJBtn7Model *sender) {
                sender.cornerRadius = 15;
            ...
            } didClickBtn7Handle:^(CKJCell *cell, CKJBtn7Model *btn7Model) {
    ...
    CKJCommonSectionModel *section4 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
    ...
    CKJCommonSectionModel *section5 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
        ...
        CKJCellModel *model1 = [CKJCellModel modelWithCellHeight:84 cellModel_id:@(kkkk_YHFStatusCellID) detailSettingBlock:^(CKJCellModel *m) {
            ...
            m.likePrice8Model = [CKJLikePriceLabel8Model likePriceLabel8ModelWithAttText:WDCKJAttributed2(@"likePrice7", [UIColor kjwd_subTitleColor969696], @14) left:0 right:rightMarign];
            m.arrow9Model = [CKJArrow9Model arrow9ModelWithImage:image right:nil];
        } didSelectRowBlock:nil];
        
        _sec.modelArray = @[model1];
    }];
    CKJCommonSectionModel *section6 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
    ...
    CKJCommonSectionModel *section7 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
    ...
    CKJCommonSectionModel *section8 = [CKJCommonSectionModel sectionWithDetailSetting:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
    ...
    self.simpleTableView.dataArr = @[section1, section2, section3, section4, section5, section6, section7, section8];
