...
- (void)initSimpleTableViewData {
  ...
  
    {
        ...
        section.headerModel = [CKJTitleStyleHeaderFooterModel modelWithAttributedString:WDCKJAttributed2(@"CKJGeneralCell的结构", [UIColor grayColor], @15) type:CKJCommonHeaderFooterType_HEADER];
    ...
    }
    {
        ...
        CKJGeneralCellModel *model4 = [CKJGeneralCellModel modelWithCellHeight:44 cellModel_id:nil detailSettingBlock:^(__kindof CKJGeneralCellModel * _Nonnull m) {
            ...
            m.image2Model = [CKJImage2Model image2ModelWithNormalImage:image size:image.size left:15];
