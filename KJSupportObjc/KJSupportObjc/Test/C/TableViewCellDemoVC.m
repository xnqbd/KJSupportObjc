...
- (void)initSimpleTableViewData {
    ...
    CKJCommonSectionModel *section1 = [CKJCommonSectionModel sectionWithDetail:^(__kindof CKJCommonSectionModel * _Nonnull _sec) {
        ...
        CKJTableViewCell1Model *model1 = [CKJTableViewCell1Model baseTableViewCellWithCellHeight:@(UITableViewAutomaticDimension) cellModel_id:nil detail:^(__kindof CKJTableViewCell1Model * _Nonnull m) {
        ...
        CKJTableViewCell1Model *model2 = [CKJTableViewCell1Model baseTableViewCellWithCellHeight:@40 cellModel_id:nil detail:^(__kindof CKJTableViewCell1Model * _Nonnull m) {
            [m _setText:@"出自《礼记·大学》"];
