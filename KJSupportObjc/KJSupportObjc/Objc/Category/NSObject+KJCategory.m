 ...
 */
- (void)executedOnceInTimeInterval:(NSTimeInterval)timeInterval block:(void(^)())block {
    NSLog(@"进来比较");
...
+ (instancetype)kj_alertTitle:(NSString *)alertTitle message:(NSString *)message alertAction_Left:(NSString *)leftActionTitle leftBlock:(void (^)())leftBlock right:(NSString *)rightActionTitle rightBlock:(void (^)())rightBlock presentingVC:(UIViewController *)presentingVC {
...
+ (instancetype)kj_alertTitle:(NSString *)alertTitle message:(NSString *)message actionSheet_top:(NSString *)topSheetTitle topBlock:(void (^)())topBlock centerSheet:(NSString *)centerSheetTitle centerBlock:(void (^)())centerBlock buttomSheet:(NSString *)buttomSheetTitle buttomBlock:(void (^)())buttomBlock presentingVC:(UIViewController *)presentingVC {
...
- (void)settoRootVCWithAnimation:(BOOL)animation {
    ...
    UIWindow *window = objc_msgSend(appdelegate, sel_registerName("window"));
...
@property (nonatomic, copy) void (^touchesBeganBlock)();
...
/** 为View增加手势 */
- (UITapGestureRecognizer *)kj_touchesBeganBlock:(void(^)())touchesBeganBlock touchesBeganRemoveFromSuperview:(BOOL)boo {
...
// touchesBeganBlock
- (void)setTouchesBeganBlock:(void (^)())touchesBeganBlock {
