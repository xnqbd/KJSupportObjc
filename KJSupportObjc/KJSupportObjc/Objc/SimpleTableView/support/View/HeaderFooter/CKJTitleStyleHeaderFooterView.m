...
- (void)setAttributedTitle:(NSAttributedString *)attributedTitle {
    if ([attributedTitle isKindOfClass:[NSString class]]) {
        _attributedTitle = WDCKJAttributed2((NSString *)attributedTitle, [UIColor lightGrayColor], @14);
    } else if ([attributedTitle isKindOfClass:[NSAttributedString class]]) {
